...
public class SpindleSwitcherUI {
    ...
    public JPanel getSelectionPanel(){
        ...
        controlPanel.setLayout(new GridLayout(13, 3));
        addDataEntryRow("Load Product Code", controlPanel, false);
        IntStream.rangeClosed(1, 12)
                .forEach(i -> addToggleButton(String.format("Spindle %s", i), controlPanel));
    ...
    public void addDataEntryRow(String buttonName, JPanel controlPanel, Boolean useIntsOnly) {
        ...
        buttonSetUser.addActionListener(e -> applyTextToLabel(formTextFields.get(buttonName), formLabels.get(buttonName)));
        addKeyboardPressToButton(buttonSetUser);
        controlPanel.add(textFieldUser);
        controlPanel.add(buttonSetUser);
        controlPanel.add(labelUser);
    }

    public void addToggleButton(String buttonName, JPanel controlPanel){
